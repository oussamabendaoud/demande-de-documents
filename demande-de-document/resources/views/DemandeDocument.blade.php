...
<head>
    ...
    <<<<<<< Updated upstream <title>Hello, world!</title>
</head>
...
<body>
    ...
    <div class="mb-3">
        ...
        <select class="form-select" id="attestation" name="attestation" required>
            ...
            <option value="attestation_scolarite" {{ old('attestation') == 'attestation_scolarite' ? 'selected' : '' }}>
                Attestation de scolarité
            </option>
            <option value="attestation_reussite" {{ old('attestation') == 'attestation_reussite' ? 'selected' : '' }}>
...
<div class="mb-3">
    <label for="attestations" class="form-label">Attestations demandées:</label>

    <div class="form-check">
        <input class="form-check-input" type="checkbox" value="attestation_inscription" id="attestation_inscription"
            name="attestations[]"
            {{ is_array(old('attestations')) && in_array('attestation_inscription', old('attestations')) ? 'checked' : '' }}>
        <label class="form-check-label" for="attestation_inscription">Attestation d'inscription</label>
    </div>

    <div class="form-check">
        <input class="form-check-input" type="checkbox" value="attestation_scolarite" id="attestation_scolarite"
            name="attestations[]"
            {{ is_array(old('attestations')) && in_array('attestation_scolarite', old('attestations')) ? 'checked' : '' }}>
        <label class="form-check-label" for="attestation_scolarite">Attestation de scolarité</label>
    </div>

    <div class="form-check">
        <input class="form-check-input" type="checkbox" value="attestation_reussite" id="attestation_reussite"
            name="attestations[]"
            {{ is_array(old('attestations')) && in_array('attestation_reussite', old('attestations')) ? 'checked' : '' }}>
        <label class="form-check-label" for="attestation_reussite">Attestation de réussite</label>
    </div>

    <div class="form-check">
        <input class="form-check-input" type="checkbox" value="releve_notes" id="releve_notes" name="attestations[]"
            {{ is_array(old('attestations')) && in_array('releve_notes', old('attestations')) ? 'checked' : '' }}>
        <label class="form-check-label" for="releve_notes">Relevé de notes</label>
    </div>

    <div class="form-check">
        <input class="form-check-input" type="checkbox" value="convention_stage" id="convention_stage"
            name="attestations[]"
            {{ is_array(old('attestations')) && in_array('convention_stage', old('attestations')) ? 'checked' : '' }}>
        <label class="form-check-label" for="convention_stage">Convention de stage</label>
    </div>

    <div class="form-check">
        <input class="form-check-input" type="checkbox" value="diplome" id="diplome" name="attestations[]"
            {{ is_array(old('attestations')) && in_array('diplome', old('attestations')) ? 'checked' : '' }}>
        <label class="form-check-label" for="diplome">Diplôme</label>
    </div>
</div>
