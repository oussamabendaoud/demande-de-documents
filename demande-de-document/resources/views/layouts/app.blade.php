    ...
    <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
        <div class="position-sticky">
            <div class="list-group list-group-flush mx-3 mt-4">
                ...
                <a href="/service-scolarite"
                    class="list-group-item list-group-item-action py-2 {{ Request::is('service-scolarite') ? 'active' : '' }}"
                    data-mdb-ripple-init>
                    <i class="fas fa-chart-area fa-fw me-3"></i><span>Scolarité </span>
                </a>
                <a href="/users"
                    class="list-group-item list-group-item-action py-2 {{ Request::is('users') ? 'active' : '' }}"
                    data-mdb-ripple-init><i class="fas fa-users fa-fw me-3"></i><span>Users</span></a>
            ...
            <ul class="navbar-nav ms-auto d-flex flex-row">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle hidden-arrow d-flex align-items-center" href="#"
                        ...
                        <img src="{{ asset('img/Logo-SupMTI-s-2024.png') }}" class="rounded-circle" height="30" alt=""
                            loading="lazy" style="background: rgb(198, 176, 176)" />
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuLink">
